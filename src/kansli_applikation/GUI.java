...
public class GUI implements WindowListener {
	...
	private void bookPlay() {
		...
		else if (controller.bandIsBooked(comboBandPlay.getSelectedItem().toString(), comboDatePlay.getSelectedItem().toString(), comboTimePlay.getSelectedItem().toString()))
			showErrorMessage(Constants.BAND_ALREADY_BOOKED);
