...
public class Constants {
	public static final String NOT_A_VALID_YEAR = "Inte ett giltigt år. Försök igen.";
	public static final String DATABASE_ERROR = "Nånting gick fel med databasen.";
	public static final String EMPTY_FIELDS = "Ett eller flera fält är tomma.";
	public static final String BAND_BOOKED = "Band bokat.";
	...
	public static final String BAND_ALREADY_BOOKED = "Bandet har redan spelning.";
}
